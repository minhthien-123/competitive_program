...
struct Matrix
{
    ...
    {
        a.assign(r, std::vector<long long>(c, -INF));
        if (is_identity)
        {
        ...
        for (int i = 0; i < r; i++)
        {
            for (int k = 0; k < c; k++)
            {
                ...
                for (int j = 0; j < other.c; j++)
                {
                    if (other.a[k][j] != -INF)
                    {
                        res.a[i][j] = std::max(res.a[i][j], a[i][k] + other.a[k][j]);
                    }
                }
            }
        }
...
void solve()
{
    ...
    for (int i = 0; i < m; i++)
    {
        ...
        u--;
        v--;
        A.a[u][v] = std::max(A.a[u][v], w);
        A.a[v][u] = std::max(A.a[v][u], w);
    }
