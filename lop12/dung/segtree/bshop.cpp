...
int query(int id, int l, int r, int x, int y)
{
    ...
    int mid = (l + r) / 2;
    int get1 = query(id * 2, l, mid, x, y);
    int get2 = query(id * 2 + 1, mid + 1, r, x, y);
...
void solve()
{
    ...
    while (q--)
    {
        int x, y;
        std::cin >> x >> y;
        int l = std::lower_bound(pos + 1, pos + n + 1, x) - pos;
        int r = std::upper_bound(pos + 1, pos + n + 1, y) - pos - 1;
