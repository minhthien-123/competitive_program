...
struct Dijkstra
{
    ...
    std::vector<long long> cnt1, cnt2;
...
__Thien_dep_trai__
{
    ...
    for (int i = 1; i <= m; i++)
    {
        ...
        long long d;
        std::cin >> u >> v >> d;
        dijk1.add_edge(u, v, d);
        dijkN.add_edge(v, u, d);
    }
    ...
    {
        bool flag = false;
        if (dijk1.dist[i] + dijkN.dist[i] == dijk1.dist[n])
        {
            long long w1 = dijk1.cnt1[i] * dijkN.cnt1[i];
            long long w2 = dijk1.cnt2[i] * dijkN.cnt2[i];

            if (w1 == dijk1.cnt1[n] && w2 == dijk1.cnt2[n])
            {
                flag = true;
            }
        }
