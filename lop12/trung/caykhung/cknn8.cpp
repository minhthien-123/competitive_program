...
{
    int n, lg;
    std::vector<std::vector<int>> up, mx;
    ...
    LCA(int n)
    {
        ...
        mx.assign(n + 7, std::vector<int>(lg + 1, 0));
        depth.assign(n + 7, 0);
    }
...
void solve()
{
    ...
    while (q--)
    {
        ...
        {
            int mx = lca.get_max_edge(f[e].u, f[e].v);
            std::cout << sum - mx + f[e].w << "\n";
        }
    }
}
